...
//			  clickButtonJS(save);
		...
		{
			  wait = new WebDriverWait(driver, Duration.ofSeconds(120));
			  wait.until(ExpectedConditions.visibilityOf(driver.findElement(LandNumericalValuetextbox)));
...
//		private By employeenotestextbox = By.xpath("//div[@id='b4-b17-b1-EmployeeNotes']/span/textarea");
		...
		private By sendapproveevaluationbutton = By.id("b4-b19-b1-b27-Btn_EvaluationEmployee_Approve");
