...
public class finalEvaluationClass {
	private WebDriver driver;
	private WebDriverWait wait;

	public finalEvaluationClass(WebDriver driver) {
		this.driver=driver;
	}
	...
	//External User
        private By newbutton = By.xpath("(//div[@class='display-flex align-items-center']/span)[1]");
  		private By casesreportbutton = By.xpath("//div[@class='display-flex margin-right-s']/span");
		private By assetstab = By.xpath("//span[text()='Asset']");
		public void openassets ()
		{
			WebElement element = driver.findElement(assetstab);
...
//
		...
		private By sendevaluationforreviewbutton = By.xpath("//button[@id='b5-b21-b29-Btn_ServiceProvider_Aprrove']");
